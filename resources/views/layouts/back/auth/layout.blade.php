...
<head>
    ...
    <link href="{{asset('resources/back/assets/css/pages/login/login-1.css')}}" rel="stylesheet" type="text/css" />
    ...
    <link href="{{asset('resources/back/assets/css/skins/header/base/light.css')}}" rel="stylesheet" type="text/css" />
...
{{--<script src="{{asset('resources/back/assets/js/pages/custom/login/login-1.js')}}" type="text/javascript"></script>--}}
