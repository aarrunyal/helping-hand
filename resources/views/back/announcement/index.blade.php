                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                &nbsp;
                                <a href="{{route('announcement.create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
                ...
                <div class="kt-portlet__body">
                    ...
                    <table class="table table-striped- table-bordered table-hover table-checkable">
                        ...
                        @if($announcements->count()>0)
                            @foreach($announcements as $c=>$announcement)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{route('announcement.edit', $announcement->slug)}}"><i class="fas fa-edit"></i></a>
                                        <a href="{{route('announcement.destroy', $announcement->slug)}}"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        @else
