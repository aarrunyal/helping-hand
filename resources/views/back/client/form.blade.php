    ...
    <div class="kt-section">
        ...
        <div class="row">
            <div class="col-lg-8 col-md-8">
                <input type="text" name="id" class="form-control" placeholder="Title" hidden
                       value="{{old('title', isset($client->id)?$client->id:null)}}">
                <div class="kt-section__content">
                    <div class="form-group row">
                        <div class="col-lg-12 col-md-12">
                            <label class="form-control-label">* Title</label>
                            <input type="text" name="title" class="form-control" placeholder="Title"
                                   value="{{old('title', isset($client->title)?$client->title:null)}}">
            ...
            <div class="col-lg-4 col-md-4">
                ...
                <div class="form-group row mt-3">
                    ...
                    <span class="kt-switch kt-switch--success ml-5">
															<label>
																<input type="checkbox"
                                                                       {{(isset($client->is_active) && $client->is_active =='1')?"checked":''}}
                                                                       name="is_active">
																<span></span>
															</label>
														</span>
