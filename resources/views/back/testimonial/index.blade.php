    ...
    <div class="kt-subheader  kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">Testimonial</h3>
                ...
                <div class="kt-portlet__body">
                    ...
                    <table class="table table-striped- table-bordered table-hover table-checkable">
                        ...
                        <tr>
                            ...
                            <th class="text-center">Word from user</th>
                            <th class="text-center">By</th>
                            <th class="text-center">Volunteered in </th>
...
{{--                                @dd($page->image_path)--}}
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{route('testimonial.destroy', $testimonial->id)}}"><i
...
@endsection
@section('page-script')
    <!--begin::Testimonial Scripts(used by this page) -->
