                ...
                <div class="kt-portlet__body">
                    ...
                    <table class="table table-striped- table-bordered table-hover table-checkable">
                        ...
                        @if($departments->count()>0)
                            @foreach($departments as $c=>$department)
                                <tr>
                                    <td class="text-center">{{$c+1}}</td>
                                    <td class="text-center">{{ucwords($department->title)}}</td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{route('department.destroy', $department->id)}}"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        @else
